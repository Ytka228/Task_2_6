    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCalc.setOnClickListener(v -> {
            ...
            try {
                ...
                Toast.makeText(getApplicationContext(), "Ошибка, ошибка ввода", Toast.LENGTH_LONG).show();
                Log.e("Error", "Number Format error (out of range)");
            }
        });
    }
}